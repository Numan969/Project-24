...
function DispatchRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!place && !subject && !number && !designation && !file_upload && !sendTo ) {
  ...
  const filteredData = data.filter((item) => {
    ...
    const placeMatch =
      ...
      const sendToMatch =
      typeof item.sendto === "string" && item.sendto.toLowerCase().includes(searchTextLower);
                ...
                <tbody className="text-gray-700">
                  {currentRecords.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className="text-left py-3 px-4">{item.sendto}</td>
              ...
              <div className="fixed inset-0 flex items-center justify-center z-50">
                <div className="bg-white rounded p-6 shadow-lg">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-sm">
                      <span className="font-semibold">Sendto:</span> {recordToDelete && data.find((item) => item._id === recordToDelete)?.Sendto}
                    </p>
                  </div>
                  {recordDate && (
                      ...
                      {showConfirmation ? (
                        <div className="bg-white rounded p-6 ">
                          ...
                          <div className="mt-4">
                            ...
                            <p className="text-sm">
                              <span className="font-semibold">Sendto:</span> {sendto}
                            </p>
                          </div>
                          {recordDate && (
                            <p className="text-sm mt-4">
