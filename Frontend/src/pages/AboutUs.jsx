...
import numan from "../assets/images/numan.jpeg"
import shiraz from "../assets/images/Muhammad-Shiraz.png"
import arslan from "../assets/images/jabir.jpg"
const AboutUs = () => {
    return (
            ...
            <section className="bg-gray-50 dark:bg-gray-800 flex-grow flex justify-center items-center py-8 lg:py-16 px-4">
                <div className="container mx-auto text-center py-8 lg:py-1 px-4">
                    ...
                    <p className="mt-4 text-lg text-gray dark:text-white mx-auto text-center">
                        At the heart of our project,  Office Automation, lies a steadfast commitment to revolutionize the daily operations at the Institute. Our mission is clear to empower the institute's staff and administrators by streamlining their manual processes through the development of a comprehensive web application.
                ...
                <div className="container mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="md:col-span-1 flex flex-col items-center">
                            ...
                            <h3 className="text-xl md:text-2xl font-semibold text-gray dark:text-white">Dr. Muhammad Shiraz</h3>
                        </div>
                        {/* Text (Column 2) */}
                ...
                <div className="container mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mt-4 md:mt-8">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            />
                            <h3 className="text-lg md:text-xl font-semibold text-gray dark:text-white">Muhammad Numan</h3>
                            <div className="flex mt-2">
                                <a href="mailto:moulanaishaq1935@gmail.com" target="_blank" className="p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                    </svg>
                                </a>
                                <a href="https://www.linkedin.com/in/muhammad-jabir-20b632254/" target="_blank" className="p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className="flex flex-col items-center">
                            <img
                                src={arslan}
                                alt="Developer 1"
                                className="w-32 md:w-48 h-62 md:h-48 rounded-full mb-4"
                            />
                            <h3 className="text-lg md:text-xl font-semibold text-gray dark:text-white">Muhammad Jabir</h3>
                            <div className="flex mt-2">
                                <a href="mailto:jabir33367@gmail.com" target="_blank" className="p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                    </svg>
                                </a>
                                <a href="https://www.linkedin.com" target="_blank" className="p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                                    </svg>
                                </a>
